...
<br/>• Firebase Auth :  Sign in, Sign up and Sign out
<br/>• Firebase Firestore : Upload & Retrieve data stored in Cloud Firestore
<br/>• Perform simple and compound queries in Cloud Firestore
<br/>• Building Complexe UI 
<br/>• Shared Preference to keep user logged in, Create chat room ( with username) & Send message ( by username)
<br/>• Using Stream & Stream builder
...
### If found this helpful so plz give a star to this repo.
